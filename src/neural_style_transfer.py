...
def transforms_img(imsize):
    ...
    return loader_style, loader_content

def image_loader(image_name, loader_style, device):
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
                       content_img, style_img, input_img, device, num_steps=3000,
